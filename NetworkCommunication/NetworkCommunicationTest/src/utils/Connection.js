...
var Connection = (function (_super) {
     ...
     * d:端口
     * */
    Connection.prototype.Connection = function (sc, d) {
    ...
    /**收到 服务器发来数据 后 执行的子程序*/
    Connection.prototype.onReceiveMessage = function (e) {
        var msg = this.webSocket.readUTF();
        console.log("收到数据：" + msg);
        this.messageEvent(msg);
    };
    /**向 服务器 发送数据*/
    Connection.prototype.sendData = function (cmd) {
        if (!this.isConnection) {
            console.log("尚未建立连接");
    ...
    Connection.prototype.messageEvent = function (msg) {
        //生成约会事件对象
